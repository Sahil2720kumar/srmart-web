...
export default function Page() {
  ...
  const footerColumns: FooterColumn[] = [
    ...
    {
      title: "Contact",
      links: ["(406) 555-0120", "www.srmart.com", "hello@srmart.com", "58, Bajar Goli, Amborkhana, Sylhet"],
    },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg sm:text-xl font-bold text-gray-900">SrMart.</span>
          </div>

          <nav className="hidden lg:flex items-center gap-6 xl:gap-8">
            {["Home", "Features", "How It Works", "Testimonials"].map((item, i) => (
              <motion.a
                key={i}
                href="#"
      ...
      >
        <motion.div variants={itemVariants}>
          ...
          >
            Your <span className="text-green-500">SrMart Grocery</span> Superstore is Here!
          </motion.h1>
          ...
          <motion.div
            ...
            variants={itemVariants}
          >
            <motion.div whileHover="hover" whileTap="tap" variants={buttonVariants} className="w-full sm:w-auto">
          ...
          >
            <motion.div variants={itemVariants}>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6">
                Download <span className="text-green-500">SrMart</span> Mobile App
              </h2>
            ...
            <motion.div className="grid grid-cols-2 gap-4 sm:gap-6" variants={containerVariants}>
              {platforms.map((item, i) => (
                <motion.div key={i} variants={itemVariants}>
                  <Card className="bg-gray-800 border-gray-700 p-4 sm:p-6 text-center hover:border-green-500 transition flex flex-col h-full">
                    ...
                    <motion.div whileHover="hover" whileTap="tap" variants={buttonVariants} className="mb-3 sm:mb-6">
      ...
      >
        <motion.div className="text-center mb-10 sm:mb-16" variants={itemVariants}>
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900">
            Exclusive Benefits of <span className="text-green-500">SrMart App</span>
          </h2>
        </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div variants={itemVariants}>
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6">
                Here's How <span className="text-green-500">SrMart</span> Delivery Works
              </h2>
      ...
      >
        ...
        >
          ...
          <p className="text-gray-700 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed px-2 sm:px-0">
            "I've been using SrMart for several months now, and I'm continually impressed with the service it provides. As a busy professional, I value convenience, and SrMart delivers that in spades."
          </p>
        </motion.div>
      </motion.section>
      ...
      {/* <motion.section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-24" ...>
        ...blog section...
      </motion.section> */}
      ...
      >
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6">
          <motion.p className="font-semibold mb-2 text-sm sm:text-base lg:text-lg" variants={itemVariants}>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <motion.div variants={itemVariants} whileHover="hover" whileTap="tap" className="w-full sm:w-auto">
      ...
      <footer className="bg-gray-900 text-gray-300 py-10 sm:py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 md:gap-12 mb-8 sm:mb-12">
            ...
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold text-white">SrMart.</span>
              </div>
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col sm:flex-row justify-between items-center text-sm text-gray-400">
            <p>Copyright © 2024 SrMart. All Rights Reserved.</p>
